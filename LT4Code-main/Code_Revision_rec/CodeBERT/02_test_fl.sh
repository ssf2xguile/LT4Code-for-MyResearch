...
CUDA_VISIBLE_DEVICES=7 python run2_12_2.py --do_test --model_type roberta      \
      --load_model_path   'model/code_doc2code_LT_fl/checkpoint-best-bleu/pytorch_model.bin' \
      --output_dir model/code_doc2code_LT_fl/out_beam5_hyp5/    \
      ...
      --learning_rate 5e-5   \
      --train_steps 160000  --eval_steps 7500 2>&1 
