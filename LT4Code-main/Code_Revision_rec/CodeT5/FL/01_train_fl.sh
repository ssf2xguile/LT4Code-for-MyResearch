...
mkdir ./model/code_doc2code_LT_fl/cache/
mkdir ./model/code_doc2code_LT_fl/outputs/
mkdir ./model/code_doc2code_LT_fl/summary/
mkdir ./model/code_doc2code_LT_fl/outputs/results
data_dir='../../../all_data/code_review_data/codet5_data/codet5_format_data/'

CUDA_VISIBLE_DEVICES=1 python  LT_run_gen.py  --do_train --do_eval --do_eval_bleu  \
        --LT_solution 'fl' \
