...
def main():
    ...
    if args.do_train:
        ...
        print("always_save_model is ", args.always_save_model)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(bar):
                ...
                if args.do_eval and (nb_tr_steps % args.eval_steps == 0 ):
                    print("nb_tr_steps % args.eval_steps == 0")
                    ...
                    logger.info("***** Checking sava_last_chechpoints *****")
                    if args.save_last_checkpoints:
                        logger.info("sava_last_chechpoints is true")
                    ...
                    logger.info("***** Checking eval_ppl < best_ppl *****")
                    if eval_ppl < best_ppl:
                        logger.info("eval_ppl is the best")
                        not_loss_dec_cnt = 0
