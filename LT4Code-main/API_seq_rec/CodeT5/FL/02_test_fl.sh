...
mkdir ./model/api_seq_rec_fl/outputs/results_beam_test
data_dir='../../../all_data/api_seq_data/codet5_data/codet5_format_data/'

CUDA_VISIBLE_DEVICES=5 python  run_gen2.py  --do_test --do_eval_bleu \
	...
	--eval_steps 17000 \
        ...
        --res_dir ./model/api_seq_rec_fl/outputs/results_beam_test  \
        --res_fn  ./model/api_seq_rec_fl/outputs/results_beam_test/summarize_codet5_base.txt  \
