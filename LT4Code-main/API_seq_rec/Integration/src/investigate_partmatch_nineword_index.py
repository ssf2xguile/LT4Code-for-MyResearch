...
def main():
    ...
    parser.add_argument('--output_file', type=str, default='../data/CodeT5_partmatch_nineword_index.txt', help="Path to save the output file")
