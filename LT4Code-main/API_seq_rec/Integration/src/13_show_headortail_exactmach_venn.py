...
def main():
    ...
    parser.add_argument('--file1', type=str, default='../data/CodeBERT_first_exactmatch_index_tail.txt', help="Path to the prediction.txt file")
    parser.add_argument('--file2', type=str, default='../data/CodeT5_first_exactmatch_index_tail.txt', help="Path to the test.json file")
    parser.add_argument('--file3', type=str, default='../data/MulaRec_first_exactmatch_index_tail.txt', help="Path to save the output file")
    parser.add_argument('--output', type=str, default='../data/Tail_First_Exactmatch_venn_for_DSW.png', help="Path to save the Venn diagram image")
