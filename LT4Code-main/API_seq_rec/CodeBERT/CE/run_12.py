...
def main():
    ...
    parser.add_argument("--LT", default='ce', type=str)
    ...
    model=Seq2Seq(encoder=encoder,decoder=decoder,config=config,
                  ...
                  sos_id=tokenizer.cls_token_id,eos_id=tokenizer.sep_token_id, LT=args.LT)
        ...
        for step in bar:
            ...
            if args.do_eval and ((global_step + 1) %args.eval_steps == 0) and eval_flag:
                ...
                if 'dev_loss' in dev_dataset:
                    ...
                    eval_examples = read_examples(args.dev_filename)#[0:5000]
