...
mkdir model/codebert_epoch30_ce/predicts/
python run2_12.py --do_test  --model_type roberta      \
     	--model_name_or_path microsoft/codebert-base   \
 	--test_filename  ${data_dir}test.json       \
     	--load_model_path  model/codebert_epoch30_ce/checkpoint-best-ppl/pytorch_model.bin  \
     	--output_dir model/codebert_epoch30_ce/predicts/   \
